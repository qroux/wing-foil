...
describe('wing-foil navigation', () => {
  ...
  it('Toggle lang on click', () => {
    const lang = window.navigator.language.split('-')[0];
    const langButton = cy.get('[data-cypress="langSwitch"]');
    langButton.should('have.length', 1);

    const frontFlag = langButton.children().first();

    lang === 'fr'
      ? frontFlag.should('have.attr', 'src', '/flags/french.png')
      : frontFlag.should('have.attr', 'src', '/flags/english.png');
